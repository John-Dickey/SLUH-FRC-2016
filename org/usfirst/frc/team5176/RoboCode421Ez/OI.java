...
public class OI {
    ...
    public OI() {
        ...
        extraButton = new JoystickButton(coJoystick, 10);
        extraButton.whileHeld(new ExtraCoPilotCommand());
        switchButton = new JoystickButton(coJoystick, 9);
        switchButton.whileHeld(new CameraSwitch());
        scissorsDownButton = new JoystickButton(coJoystick, 8);
        scissorsDownButton.whileHeld(new ScissorsDown());
        scissorsUpButton = new JoystickButton(coJoystick, 7);
        scissorsUpButton.whileHeld(new ScissorsUp());
        reloadButton = new JoystickButton(coJoystick, 6);
        reloadButton.whileHeld(new Reload());
        shootBall = new JoystickButton(coJoystick, 5);
        shootBall.whileHeld(new ShootBallPID());
        spinOutButton = new JoystickButton(coJoystick, 4);
        spinOutButton.whileHeld(new SpinPickupArmsOut());
        spinInButton = new JoystickButton(coJoystick, 3);
        spinInButton.whileHeld(new SpinPickupArmsIn());
        lowerButton = new JoystickButton(coJoystick, 2);
        lowerButton.whileHeld(new LowerPickupArms());
        raiseButton = new JoystickButton(coJoystick, 1);
        raiseButton.whileHeld(new RaisePickupArms());
        pilotJoystick = new Joystick(0);
        
        pilotButton2 = new JoystickButton(pilotJoystick, 2);
        pilotButton2.whileHeld(new ExtraPilotCommand2());
        pilotButton1 = new JoystickButton(pilotJoystick, 1);
        ...
        SmartDashboard.putData("Shoot Ball PID", new ShootBallPID());
